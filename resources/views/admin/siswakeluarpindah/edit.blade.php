...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Siswa Keluar/Pindah (Edit)</li>
      </ol>
    </section>
  <!-- Main content -->
      ...
      <div class="col-xs-12">
        ...
        <div class="box box-warning">
          <div class="box-header with-border">
            <h3 class="box-title">Ubah Data Siswa Keluar/Pindah</h3>
          </div>
          <!-- /.box-header -->
          <!-- form start -->
          <form role="form" class="form-update" action="{{url('admin/keluarpindah/'.$keluarPindah->id)}}" method="post">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="alasan" rows="3" id="alasan" placeholder="Alasan" required>{{$keluarPindah->alasan}}</textarea>
              </div>
            </div>
            <!-- /.box-body -->
