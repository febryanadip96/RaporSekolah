              ...
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  @foreach($kelasBukas as $index => $kelasBuka)
                    ...
                    <td><a class="btn btn-default btn-xs" href="{{url('admin/aturkelas/'.$kelasBuka->id)}}"><span class="fa fa-gear"></span></a> <a class="btn btn-warning btn-xs" href="{{url('admin/kelasbuka/'.$kelasBuka->id.'/edit')}}"><span class="fa fa-pencil"></span></a></td>
                    </tr>
                  @endforeach
                </tbody>
              </table>
