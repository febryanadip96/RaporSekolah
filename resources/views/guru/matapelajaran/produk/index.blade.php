              ...
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  @foreach($kompetensiDasars as $index => $kompetensiDasar)
                    ...
                    <td><a data-toggle="tooltip" title="Input Nilai" class="btn btn-default btn-xs" href="{{url('guru/matapelajaran/produk/'.$mapelBuka->id.'/kd/'.$kompetensiDasar->id)}}"><span class="fa fa-edit"></span></a></td>
                    </tr>
                  @endforeach
                </tbody>
              </table>
