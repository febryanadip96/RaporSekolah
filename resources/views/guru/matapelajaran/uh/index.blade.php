...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Ulangan Harian (KD)</li>
      </ol>
    </section>
  <!-- Main content -->
              ...
              <table class="table table-bordered table-hover">
                ...
                <tbody>
                  @foreach($kompetensiDasars as $index => $kompetensiDasar)
                    ...
                    <td><a data-toggle="tooltip" title="Input Nilai" class="btn btn-default btn-xs" href="{{url('guru/matapelajaran/uh/'.$mapelBuka->id.'/kd/'.$kompetensiDasar->id)}}"><span class="fa fa-edit"></span></a></td>
                    </tr>
                  @endforeach
                </tbody>
              </table>
