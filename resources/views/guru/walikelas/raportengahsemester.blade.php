		  	...
		  	<section class="invoice">
			    ...
			    <div class="row">
			      	...
			      	<div class="col-xs-12 text-center">
						<img src="{{asset('img/logo_sekolah.png')}}" height="100" width="100">
						<h2>{{$sekolah->nama}}</h2>
			            <h4>Laporan Hasil Belajar Siswa</h4>
			            <small>(Tengah Semester @if($semesterSiswa->semester->gasal_genap==1) Gasal @else Genap @endif)</small><br><br>
					</div>
					<div class="col-xs-12">
				        <table>
				            <tr>
